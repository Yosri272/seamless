...
<div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-extra clearfix pt-2 pb-3 mb-3">
                        <form action="{{  ('m_search')  }}" method="GET" class="form-inline guide-advanced-search" novalidate="">
    ...
    <a href="{{  url('m_getpdf')  }}" class="btn btn-primary">print report</a>
...
<a class="btn btn-info" href="{{  url('m_editm_view')  }}/{{  $data->id  }}">
<i class="fa fa-edit"></i>
</a>

<a class="btn btn-danger" href="{{  url('m_distory')  }}/{{  $data->id  }}">
