...
<div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="card-body">
                  <form method="GET" action="{{  ('ve_register1')  }}">
                        @csrf
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-md-5">
                                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Products') }}</label>
                                        ...
                                        <input id="products" type="text" class="form-control @error('products') is-invalid @enderror" name="products" value="{{ old('products') }}" required autocomplete="products" autofocus>
