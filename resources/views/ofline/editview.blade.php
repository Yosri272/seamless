                                   ...
                                   <select class="form-control" name="customer_location">
                                    ...
                                    <div class="col-md-5">
                                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Customer local') }}</label>
                                            ...
                                            <input id="customer_local" type="text" class="form-control @error('customer_local') is-invalid @enderror" name="customer_local" value="{{ $edit->customer_local }}"" required autocomplete="customer_local" autofocus>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-md-5">
                                                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Delevery Fees') }}</label>
                                                        ...
                                                        <input id="delevery_fees" type="number" class="form-control @error('delevery_fees') is-invalid @enderror" name="delevery_fees" value="{{ $edit->delevery_fees }}" required autocomplete="delevery_fees" autofocus>
